...
//    for (Point p : shape) {
	...
	// Uses ray casting to check if polygons intersect
	...
	public boolean collides(Polygon polygon) {
		Point[] homePoints = this.getPoints();
		Point[] awayPoints = polygon.getPoints();

		for (Point point : homePoints) {
